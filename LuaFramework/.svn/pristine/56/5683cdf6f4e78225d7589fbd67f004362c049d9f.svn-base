...
local  LeetoleManLogicSwitchCard = BaseSwitchCardLogic:New("LeetoleManLogicSwitchCard")
local this = LeetoleManLogicSwitchCard
this.moduleName = "LeetoleManLogicSwitchCard"

function LeetoleManLogicSwitchCard:InitLogic()
...
--- 切换卡牌
function LeetoleManLogicSwitchCard:StartSwitchCard()
...
function LeetoleManLogicSwitchCard:IsShowing(cardId)
...
--- 切换卡牌
function LeetoleManLogicSwitchCard:EnterDoubleJackpotChangeCard()
...
function LeetoleManLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- 有Jackpot的卡牌自动移动到后面
function LeetoleManLogicSwitchCard:StartHideJackpotCardBackground(currCardId,otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5,0.3,-1,function()
        if ModelList.LeetoleManModel:IsGameOver() then
           self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function LeetoleManLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function LeetoleManLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function LeetoleManLogicSwitchCard:GetsCurrCardOrder()
