...
local SettleTransitionExitState = Clazz(BaseFsmState,"SettleTransitionExitState")
local this = SettleTransitionExitState

function SettleTransitionExitState:OnEnter(fsm,previous,...)
    this._fsm = fsm
    this.PlayExit = false
...
function SettleTransitionExitState:PlayExitAnim()
...
function SettleTransitionExitState:OnLeave(fsm)

end

return SettleTransitionExitState