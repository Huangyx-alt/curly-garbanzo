...
require "View/HallCity/LetemRollConsoleView"
LetemRollFunctionContainer = HallFunctionContainer:New()

function LetemRollFunctionContainer:Init()
    ...
    self._jackpotConsole = LetemRollConsoleView:New(JackepotHost.mainLobby)
