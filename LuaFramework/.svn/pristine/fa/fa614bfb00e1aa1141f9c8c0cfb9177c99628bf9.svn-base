...
require "View/HallCity/BisonConsoleView"
BisonFunctionContainer = HallFunctionContainer:New()

function BisonFunctionContainer:Init()
    ...
    self._jackpotConsole = BisonConsoleView:New(JackepotHost.mainLobby)
