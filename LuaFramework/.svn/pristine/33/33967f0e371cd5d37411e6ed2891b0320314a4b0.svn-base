...
local NewLeetoleManSingleCardView = BaseSingleCard:New();
local this = NewLeetoleManSingleCardView;
...
function NewLeetoleManSingleCardView:OnEnable(params)

end

function NewLeetoleManSingleCardView:OnDisable()

end

function NewLeetoleManSingleCardView:BindObj(obj, parentView, cardID)
...
function NewLeetoleManSingleCardView:Clone(name)
    local o = { name = name }
    setmetatable(o, self)
    self.__index = self
    return o
...
function NewLeetoleManSingleCardView:AddBowlDrink(bowlTable, cardId, bowlType, addCount)
...
function NewLeetoleManSingleCardView:ForbidCollider()
