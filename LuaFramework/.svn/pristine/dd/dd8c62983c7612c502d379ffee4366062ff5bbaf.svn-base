...
local GoldenPigFlyItemEffect = BaseFlyItemEffect:New("GoldenPigFlyItemEffect")
local this = GoldenPigFlyItemEffect
...
function this:ShowSkillBingo(cardId, cellIndex)
    ...
    BattleEffectCache:GetSkillPrefabFromCache("GoldenPigskill2", cellData.obj, function(obj)
        --obj.transform.position = pos
        self:SameScaleWithCard(obj, cardId)
        UISound.play("goldenpigGoldkey")
        ...
        LuaTimer:SetDelayFunction(1, function()
            table.each(cellPosList, function(cellID, k)
                ...
                if cellData:IsNotSign() then
                    ...
                    BattleEffectCache:GetSkillPrefabFromCache("GoldenPigBingoSkillget", cellData.obj, function()
