...
---@class  NewChristmasHallViewGuide : ApplicationGuideInfo
local NewChristmasHallViewGuide = ApplicationGuideInfo:New()
local this = NewChristmasHallViewGuide

function NewChristmasHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("NewChristmasHallViewGuide:Init")
end
...
function NewChristmasHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("NewChristmasHallViewGuide:Remove")
    this:UnRegister()
end

function NewChristmasHallViewGuide:DelayCheck()
    RemoveDelay()
...
function NewChristmasHallViewGuide:Check()
...
function NewChristmasHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function NewChristmasHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function NewChristmasHallViewGuide:UnRegister()
