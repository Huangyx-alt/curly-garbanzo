...
---@class  SolitaireHallViewGuide : ApplicationGuideInfo
local SolitaireHallViewGuide = ApplicationGuideInfo:New()
local this = SolitaireHallViewGuide

function SolitaireHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("SolitaireHallViewGuide:Init")
end
...
function SolitaireHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("SolitaireHallViewGuide:Remove")
    this:UnRegister()
end

function SolitaireHallViewGuide:DelayCheck()
    RemoveDelay()
...
function SolitaireHallViewGuide:Check()
...
function SolitaireHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function SolitaireHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function SolitaireHallViewGuide:UnRegister()
