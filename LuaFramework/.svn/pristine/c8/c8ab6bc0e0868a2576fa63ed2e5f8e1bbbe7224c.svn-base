...
local PiggyBankSettleDetailView = BingoSettleDetailView:New('PiggyBankSettleDetailView')
local this = PiggyBankSettleDetailView
...
function PiggyBankSettleDetailView:OnDisable()
    BingoSettleDetailView.OnDisable(self)
    self.newCount = 0
end

function PiggyBankSettleDetailView:InitPuzzleShow()

end

function PiggyBankSettleDetailView:InitOthers()
...
function PiggyBankSettleDetailView:StartFinalSequence(cmd)
    --local miniGameCfg = Csv.GetData("new_minigame", this.MiniGamID)
    --if not miniGameCfg then
