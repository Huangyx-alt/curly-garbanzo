...
local ChristmasSynthesisLogicSwitchCard = BaseSwitchCardLogic:New("ChristmasSynthesisLogicSwitchCard")
local this = ChristmasSynthesisLogicSwitchCard
this.moduleName = "ChristmasSynthesisLogicSwitchCard"

function ChristmasSynthesisLogicSwitchCard:InitLogic()
...
--- �л�����
function ChristmasSynthesisLogicSwitchCard:StartSwitchCard()
...
function ChristmasSynthesisLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function ChristmasSynthesisLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function ChristmasSynthesisLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function ChristmasSynthesisLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.ChristmasSynthesisModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function ChristmasSynthesisLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function ChristmasSynthesisLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function ChristmasSynthesisLogicSwitchCard:GetsCurrCardOrder()
