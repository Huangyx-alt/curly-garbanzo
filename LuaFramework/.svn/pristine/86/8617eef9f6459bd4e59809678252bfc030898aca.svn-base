...
-- import"PB_ItemInfo.proto",
 ...
 PB_GameBallShakerInfo_Req  =  {
}

 PB_GameBallShakerInfo_Res  =  {
    ...
    bonusEvent          =  5,-- repeated PB_BonusEvent ,    --奖励事件盖章
    jackpotRuleId                        =  6,-- int32 jackpotRuleId ,    --Jackpot规则ID
    totalWin                             =  7,-- int64 totalWin ,    --总奖励值（初始）
}
 ...
 PB_ShakerBall  =  {
    ...
    number  =  2,-- int32 number ,     --出球数字，特殊数据，99
    spendCoin  =  3,-- int32 spendCoin ,  --花费金币
    bonusEvent  =  4,-- repeated PB_BonusEvent ,   --奖励事件盖章
