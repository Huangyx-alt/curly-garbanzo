...
local GiftPackPirateShipInMainView = GiftPackBaseView:New('GiftPackPirateShipInMainView', "GiftPackNewYearAtlas")
local this = GiftPackPirateShipInMainView
...
function GiftPackPirateShipInMainView:Awake(obj)
    self:on_init()
...
function GiftPackPirateShipInMainView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackPirateShipInMainView:OnDisable()
...
function GiftPackPirateShipInMainView:ClearCountDown()
...
function GiftPackPirateShipInMainView:ShowItemGrid()
...
function GiftPackPirateShipInMainView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackPirateShipInMainView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackPirateShipInMainView:ClearMailList()
...
function GiftPackPirateShipInMainView:GetItemViewInstance(index)
...
function GiftPackPirateShipInMainView:ShowDetailGift()
...
function GiftPackPirateShipInMainView:SetLeftTime(endTimeStamp)
...
function GiftPackPirateShipInMainView:OnDestroy()
    log.g("GiftPackPirateShipInMainView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackPirateShipInMainView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackPirateShipInMainView:ClosePackView()
...
function GiftPackPirateShipInMainView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackPirateShipInMainView:OnBuySuccess(needClose,itemData)
...
function GiftPackPirateShipInMainView:showGetRewardEffect(itemData,isFree)
...
function GiftPackPirateShipInMainView:SetTimer()
...
--领取成功
function GiftPackPirateShipInMainView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackPirateShipInMainView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackPirateShipInMainView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackPirateShipInMainView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
