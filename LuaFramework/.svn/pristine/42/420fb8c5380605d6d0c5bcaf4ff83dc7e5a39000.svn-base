...
require "View/HallCity/GoldenTrainConsoleView"
GoldenTrainFunctionContainer = HallFunctionContainer:New()

function GoldenTrainFunctionContainer:Init()
    ...
    self._jackpotConsole = GoldenTrainConsoleView:New(JackepotHost.mainLobby)
