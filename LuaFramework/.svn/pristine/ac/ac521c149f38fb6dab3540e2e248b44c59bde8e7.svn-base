...
local DragonFortuneLogicSwitchCard = BaseSwitchCardLogic:New("DragonFortuneLogicSwitchCard")
local this = DragonFortuneLogicSwitchCard
this.moduleName = "DragonFortuneLogicSwitchCard"

function DragonFortuneLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function DragonFortuneLogicSwitchCard:StartSwitchCard()
...
function DragonFortuneLogicSwitchCard:IsShowing(cardId)
...
function DragonFortuneLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function DragonFortuneLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function DragonFortuneLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.DragonFortuneModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function DragonFortuneLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function DragonFortuneLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function DragonFortuneLogicSwitchCard:GetsCurrCardOrder()
