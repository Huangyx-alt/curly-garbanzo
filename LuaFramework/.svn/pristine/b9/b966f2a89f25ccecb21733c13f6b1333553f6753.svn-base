...
local GiftPackPirateShipWView = GiftPackBaseView:New('GiftPackPirateShipWView')
local this = GiftPackPirateShipWView
...
function GiftPackPirateShipWView:Awake(obj)
    self:on_init()
...
function GiftPackPirateShipWView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackPirateShipWView:OnDisable()
...
function GiftPackPirateShipWView:ClearCountDown()
...
function GiftPackPirateShipWView:ShowItemGrid()
...
function GiftPackPirateShipWView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack() 
    local tmpData = Csv.getPopInfiniteForId(_data.pId)
    local count = 0
...
function GiftPackPirateShipWView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackPirateShipWView:ClearMailList()
...
function GiftPackPirateShipWView:GetItemViewInstance(index)
...
function GiftPackPirateShipWView:ShowDetailGift()
...
function GiftPackPirateShipWView:SetLeftTime(endTimeStamp)
...
function GiftPackPirateShipWView:OnDestroy()
    log.g("GiftPackPirateShipWView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackPirateShipWView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackPirateShipWView:ClosePackView()
...
function GiftPackPirateShipWView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackPirateShipWView:OnBuySuccess(needClose,itemData)
...
function GiftPackPirateShipWView:showGetRewardEffect(itemData,isFree)
...
function GiftPackPirateShipWView:SetTimer()
...
--领取成功
function GiftPackPirateShipWView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackPirateShipWView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackPirateShipWView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackPirateShipWView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
