...
require "View/HallCity/MoleMinerConsoleView"
MoleMinerFunctionContainer = HallFunctionContainer:New()

function MoleMinerFunctionContainer:Init()
    ...
    self._jackpotConsole = MoleMinerConsoleView:New(JackepotHost.mainLobby)
