...
local GiftPackEasterInMainView = GiftPackBaseView:New('GiftPackEasterInMainView', "GiftPackNewYearAtlas")
local this = GiftPackEasterInMainView
...
function GiftPackEasterInMainView:Awake(obj)
    self:on_init()
...
function GiftPackEasterInMainView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackEasterInMainView:OnDisable()
...
function GiftPackEasterInMainView:ClearCountDown()
...
function GiftPackEasterInMainView:ShowItemGrid()
...
function GiftPackEasterInMainView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackEasterInMainView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackEasterInMainView:ClearMailList()
...
function GiftPackEasterInMainView:GetItemViewInstance(index)
...
function GiftPackEasterInMainView:ShowDetailGift()
...
function GiftPackEasterInMainView:SetLeftTime(endTimeStamp)
...
function GiftPackEasterInMainView:OnDestroy()
    log.g("GiftPackEasterInMainView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackEasterInMainView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackEasterInMainView:ClosePackView()
...
function GiftPackEasterInMainView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackEasterInMainView:OnBuySuccess(needClose,itemData)
...
function GiftPackEasterInMainView:showGetRewardEffect(itemData,isFree)
...
function GiftPackEasterInMainView:SetTimer()
...
--领取成功
function GiftPackEasterInMainView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackEasterInMainView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackEasterInMainView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackEasterInMainView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
