...
require "View/HallCity/DragonFortuneConsoleView"
DragonFortuneFunctionContainer = HallFunctionContainer:New()

function DragonFortuneFunctionContainer:Init()
    ...
    self._jackpotConsole = DragonFortuneConsoleView:New(JackepotHost.mainLobby)
