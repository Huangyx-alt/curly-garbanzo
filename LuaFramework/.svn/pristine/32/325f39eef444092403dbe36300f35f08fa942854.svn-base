...
local MoleMinerPuSkill = BaseSkill:New("MoleMinerPuSkill")
local this = MoleMinerPuSkill
local private = {}

--��ʯ�淨-����
function MoleMinerPuSkill:ShowSkill(cardId,cellIndex,powerId,skillId)
    ...
    BattleEffectCache:GetSkillPrefabFromCache("MoleMinerskill2zuantou", target, function(obj)
        UISound.play("minerdrill")
        
        local cellIndexs = private.GetSkillCells(cellIndex)
        local signDelays = {0.5, 0.7, 0.9, 1.1}
