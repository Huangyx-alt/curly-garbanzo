...
require "View/HallCity/NewLeetoleManConsoleView"
NewLeetoleManFunctionContainer = HallFunctionContainer:New()

function NewLeetoleManFunctionContainer:Init()
    ...
    self._jackpotConsole = NewLeetoleManConsoleView:New(JackepotHost.mainLobby)
