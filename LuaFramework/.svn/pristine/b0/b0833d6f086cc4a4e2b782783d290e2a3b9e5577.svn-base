...
local MonopolyBingoView = BaseBingoView:New("MonopolyBingoView", "MonopolyBingoAtlas")
local this = MonopolyBingoView
this.ViewName = "MonopolyBingoView"
...
function this.OnDropBall(currNumber)
    Facade.SendNotification(NotifyName.Bingo.OneNumberCallFinish, currNumber)
    BaseBingoView.OnDropBall(currNumber)
end
