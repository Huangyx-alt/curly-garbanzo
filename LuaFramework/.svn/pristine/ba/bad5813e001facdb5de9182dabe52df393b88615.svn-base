...
local TournamentBlackGoldMyRankItem = TournamentRankItem:New()
local this = TournamentBlackGoldMyRankItem
...
function TournamentBlackGoldMyRankItem:Awake()
    self:on_init()
end

function TournamentBlackGoldMyRankItem:OnDispose()
    reward_item = nil
end

function TournamentBlackGoldMyRankItem:IsMyRank()
    return true
end

function TournamentBlackGoldMyRankItem:RequestPlayerTournamentInfo()
    --点击自己不弹出玩家信息
end

function TournamentBlackGoldMyRankItem:GetHeadIcon()
    return fun.get_strNoEmpty(ModelList.PlayerInfoModel:GetHeadIcon(), "xxl_head016")
end

function TournamentBlackGoldMyRankItem:SetRewardItem(tiers,difficulty,order)
...
function TournamentBlackGoldMyRankItem:GetBuffPosParams()
    local params = {}
