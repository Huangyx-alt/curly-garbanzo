...
---@class  ScratchWinnerHallViewGuide : ApplicationGuideInfo
local ScratchWinnerHallViewGuide = ApplicationGuideInfo:New()
local this = ScratchWinnerHallViewGuide

function ScratchWinnerHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("ScratchWinnerHallViewGuide:Init")
end
...
function ScratchWinnerHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("ScratchWinnerHallViewGuide:Remove")
    this:UnRegister()
end

function ScratchWinnerHallViewGuide:DelayCheck()
    RemoveDelay()
...
function ScratchWinnerHallViewGuide:Check()
...
function ScratchWinnerHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function ScratchWinnerHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function ScratchWinnerHallViewGuide:UnRegister()
