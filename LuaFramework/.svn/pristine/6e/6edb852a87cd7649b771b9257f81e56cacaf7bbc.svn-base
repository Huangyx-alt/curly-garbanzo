...
---@class  PiggyBankHallViewGuide : ApplicationGuideInfo
local PiggyBankHallViewGuide = ApplicationGuideInfo:New()
local this = PiggyBankHallViewGuide

function PiggyBankHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("PiggyBankHallViewGuide:Init")
end
...
function PiggyBankHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("PiggyBankHallViewGuide:Remove")
    this:UnRegister()
end

function PiggyBankHallViewGuide:DelayCheck()
    RemoveDelay()
...
function PiggyBankHallViewGuide:Check()
...
function PiggyBankHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function PiggyBankHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function PiggyBankHallViewGuide:UnRegister()
