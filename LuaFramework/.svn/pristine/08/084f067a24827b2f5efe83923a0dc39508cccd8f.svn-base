...
local GotYouConsoleView =  require "View/HallCity/GotYouConsoleView"
GotYouFunctionContainer = HallFunctionContainer:New()

function GotYouFunctionContainer:Init()
    ...
    self._jackpotConsole = GotYouConsoleView:New(JackepotHost.mainLobby)
