...
---@class  DragonFortuneHallViewGuide : ApplicationGuideInfo
local DragonFortuneHallViewGuide = ApplicationGuideInfo:New()
local this = DragonFortuneHallViewGuide

function DragonFortuneHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("DragonFortuneHallViewGuide:Init")
end
...
function DragonFortuneHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("DragonFortuneHallViewGuide:Remove")
    this:UnRegister()
end

function DragonFortuneHallViewGuide:DelayCheck()
    RemoveDelay()
...
function DragonFortuneHallViewGuide:Check()
...
function DragonFortuneHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function DragonFortuneHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function DragonFortuneHallViewGuide:UnRegister()
