...
---@class  MoleMinerHallViewGuide : ApplicationGuideInfo
local MoleMinerHallViewGuide = ApplicationGuideInfo:New()
local this = MoleMinerHallViewGuide

function MoleMinerHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("MoleMinerHallViewGuide:Init")
end
...
function MoleMinerHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("MoleMinerHallViewGuide:Remove")
    this:UnRegister()
end

function MoleMinerHallViewGuide:DelayCheck()
    RemoveDelay()
...
function MoleMinerHallViewGuide:Check()
...
function MoleMinerHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function MoleMinerHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function MoleMinerHallViewGuide:UnRegister()
