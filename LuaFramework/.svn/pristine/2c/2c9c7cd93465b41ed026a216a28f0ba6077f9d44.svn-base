...
require "View/HallCity/GemQueenConsoleView"
GemQueenFunctionContainer = HallFunctionContainer:New()

function GemQueenFunctionContainer:Init()
    ...
    self._jackpotConsole = GemQueenConsoleView:New(JackepotHost.mainLobby)
