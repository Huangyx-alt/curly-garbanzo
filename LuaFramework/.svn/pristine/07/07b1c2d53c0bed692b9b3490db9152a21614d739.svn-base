...
local ChristmasSynthesisConsoleView =  require "View/HallCity/ChristmasSynthesisConsoleView"
ChristmasSynthesisFunctionContainer = HallFunctionContainer:New()

function ChristmasSynthesisFunctionContainer:Init()
    ...
    self._jackpotConsole = ChristmasSynthesisConsoleView:New(JackepotHost.mainLobby)
