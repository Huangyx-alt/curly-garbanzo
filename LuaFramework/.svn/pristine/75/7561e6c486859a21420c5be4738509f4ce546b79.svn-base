...
local ScratchWinnerLogicSwitchCard = BaseSwitchCardLogic:New("ScratchWinnerLogicSwitchCard")
local this = ScratchWinnerLogicSwitchCard
this.moduleName = "ScratchWinnerLogicSwitchCard"

function ScratchWinnerLogicSwitchCard:InitLogic()
...
--- �л�����
function ScratchWinnerLogicSwitchCard:StartSwitchCard()
...
function ScratchWinnerLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function ScratchWinnerLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function ScratchWinnerLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function ScratchWinnerLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.ScratchWinnerModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function ScratchWinnerLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function ScratchWinnerLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function ScratchWinnerLogicSwitchCard:GetsCurrCardOrder()
