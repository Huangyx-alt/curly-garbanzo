...
--- Created by PC.
--- DateTime: 2023/12/22 11:26
---

---
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by PC.
--- DateTime: 2023/12/11 12:29
---
local GiftPackBaseView = require("View.GiftPack.GiftPackBaseView")
local GiftPackNewLeetoleManInMainView = GiftPackBaseView:New('GiftPackNewLeetoleManInMainView', "GiftPackNewYearAtlas")
local this = GiftPackNewLeetoleManInMainView
...
function GiftPackNewLeetoleManInMainView:Awake(obj)
    self:on_init()
...
function GiftPackNewLeetoleManInMainView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackNewLeetoleManInMainView:OnDisable()
...
function GiftPackNewLeetoleManInMainView:ClearCountDown()
...
function GiftPackNewLeetoleManInMainView:ShowItemGrid()
...
function GiftPackNewLeetoleManInMainView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackNewLeetoleManInMainView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackNewLeetoleManInMainView:ClearMailList()
...
function GiftPackNewLeetoleManInMainView:GetItemViewInstance(index)
...
function GiftPackNewLeetoleManInMainView:ShowDetailGift()
...
function GiftPackNewLeetoleManInMainView:SetLeftTime(endTimeStamp)
...
function GiftPackNewLeetoleManInMainView:OnDestroy()
    log.g("GiftPackNewLeetoleManInMainView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackNewLeetoleManInMainView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackNewLeetoleManInMainView:ClosePackView()
...
function GiftPackNewLeetoleManInMainView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackNewLeetoleManInMainView:OnBuySuccess(needClose,itemData)
...
function GiftPackNewLeetoleManInMainView:showGetRewardEffect(itemData,isFree)
...
function GiftPackNewLeetoleManInMainView:SetTimer()
...
--领取成功
function GiftPackNewLeetoleManInMainView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackNewLeetoleManInMainView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackNewLeetoleManInMainView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackNewLeetoleManInMainView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
