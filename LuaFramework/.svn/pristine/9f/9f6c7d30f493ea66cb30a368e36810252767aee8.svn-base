...
---@class  EasterHallViewGuide : ApplicationGuideInfo
local EasterHallViewGuide = ApplicationGuideInfo:New()
local this = EasterHallViewGuide

function EasterHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("EasterHallViewGuide:Init")
end
...
function EasterHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("EasterHallViewGuide:Remove")
    this:UnRegister()
end

function EasterHallViewGuide:DelayCheck()
    RemoveDelay()
...
function EasterHallViewGuide:Check()
...
function EasterHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
