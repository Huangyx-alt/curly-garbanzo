...
require "View/HallCity/PirateShipConsoleView"
PirateShipFunctionContainer = HallFunctionContainer:New()

function PirateShipFunctionContainer:Init()
    ...
    self._jackpotConsole = PirateShipConsoleView:New(JackepotHost.mainLobby)
