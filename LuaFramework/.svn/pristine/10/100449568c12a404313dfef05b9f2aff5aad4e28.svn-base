...
---@class  SingleWolfHallViewGuide : ApplicationGuideInfo
local SingleWolfHallViewGuide = ApplicationGuideInfo:New()
local this = SingleWolfHallViewGuide

function SingleWolfHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("SingleWolfHallViewGuide:Init")
end
...
function SingleWolfHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil,true,nil,true)
    log.r("SingleWolfHallViewGuide:Remove")
    this:UnRegister()
end

function SingleWolfHallViewGuide:DelayCheck()
    RemoveDelay()
...
function SingleWolfHallViewGuide:Check()
...
function SingleWolfHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function SingleWolfHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function SingleWolfHallViewGuide:UnRegister()
