...
local GiftPack25NewYearsUnlimitView = GiftPackBaseView:New('GiftPack25NewYearsUnlimitView', "GiftPack25NewYearsUnlimitAtlas")
local this = GiftPack25NewYearsUnlimitView
...
function GiftPack25NewYearsUnlimitView:Awake(obj)
    self:on_init()
    Facade.RegisterView(self)
end

function GiftPack25NewYearsUnlimitView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPack25NewYearsUnlimitView:OnDisable()
...
function GiftPack25NewYearsUnlimitView:ClearCountDown()
...
function GiftPack25NewYearsUnlimitView:ShowItemGrid()
    ...
    self.title:ShowSprite(self:Icon2ImgName(xls.icon))
end

function GiftPack25NewYearsUnlimitView:Icon2ImgName(icon)
    local map ={
        cEnt25newyearscoin = "xinnianwuxianlibao010",
        cEnt25newyearsdiamond = "xinnianwuxianlibao03",
    }

    return map[icon] or "xinnianwuxianlibao010"
end

function GiftPack25NewYearsUnlimitView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPack25NewYearsUnlimitView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPack25NewYearsUnlimitView:ClearMailList()
...
function GiftPack25NewYearsUnlimitView:GetItemViewInstance(index)
...
function GiftPack25NewYearsUnlimitView:ShowDetailGift()
    self:ShowItemGrid()
end

function GiftPack25NewYearsUnlimitView:SetLeftTime(endTimeStamp)
...
function GiftPack25NewYearsUnlimitView:OnDestroy()
    log.g("GiftPack25NewYearsUnlimitView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPack25NewYearsUnlimitView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPack25NewYearsUnlimitView:ClosePackView()
    if _Delopptimer2 ~= nil then
        LuaTimer:Remove(_Delopptimer2)
    end
...
function GiftPack25NewYearsUnlimitView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPack25NewYearsUnlimitView:OnBuySuccess(needClose,itemData)
...
function GiftPack25NewYearsUnlimitView:showGetRewardEffect(itemData,isFree)
...
function GiftPack25NewYearsUnlimitView:SetTimer()
...
--领取成功
function GiftPack25NewYearsUnlimitView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPack25NewYearsUnlimitView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPack25NewYearsUnlimitView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPack25NewYearsUnlimitView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
