...
local GemQueenLogicSwitchCard = BaseSwitchCardLogic:New("GemQueenLogicSwitchCard")
local this = GemQueenLogicSwitchCard
this.moduleName = "GemQueenLogicSwitchCard"

function GemQueenLogicSwitchCard:InitLogic()
...
--- 切换卡牌
function GemQueenLogicSwitchCard:StartSwitchCard()
...
function GemQueenLogicSwitchCard:IsShowing(cardId)
...
--- 切换卡牌
function GemQueenLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function GemQueenLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- 有Jackpot的卡牌自动移动到后面
function GemQueenLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.GemQueenModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function GemQueenLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function GemQueenLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function GemQueenLogicSwitchCard:GetsCurrCardOrder()
