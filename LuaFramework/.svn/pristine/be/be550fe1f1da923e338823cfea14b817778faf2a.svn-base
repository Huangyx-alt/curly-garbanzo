...
---@class  MonopolyHallViewGuide : ApplicationGuideInfo
local MonopolyHallViewGuide = ApplicationGuideInfo:New()
local this = MonopolyHallViewGuide

function MonopolyHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("MonopolyHallViewGuide:Init")
end
...
function MonopolyHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("MonopolyHallViewGuide:Remove")
    this:UnRegister()
end

function MonopolyHallViewGuide:DelayCheck()
    RemoveDelay()
...
function MonopolyHallViewGuide:Check()
...
function MonopolyHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function MonopolyHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function MonopolyHallViewGuide:UnRegister()
