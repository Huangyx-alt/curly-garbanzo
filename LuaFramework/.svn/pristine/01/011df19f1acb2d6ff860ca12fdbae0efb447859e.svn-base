...
local GiftPackNewYearView = GiftPackBaseView:New('GiftPackNewYearView', "GiftPackNewYearAtlas")
local this = GiftPackNewYearView
...
function GiftPackNewYearView:Awake(obj)
    self:on_init()
    Facade.RegisterView(self)
end

function GiftPackNewYearView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackNewYearView:OnDisable()
...
function GiftPackNewYearView:ClearCountDown()
...
function GiftPackNewYearView:ShowItemGrid()
...
function GiftPackNewYearView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackNewYearView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackNewYearView:ClearMailList()
...
function GiftPackNewYearView:GetItemViewInstance(index)
...
function GiftPackNewYearView:ShowDetailGift()
    self:ShowItemGrid()
end

function GiftPackNewYearView:SetLeftTime(endTimeStamp)
...
function GiftPackNewYearView:OnDestroy()
    log.g("GiftPackNewYearView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackNewYearView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackNewYearView:ClosePackView()
    ...
    self:ClearCountDown()
    Facade.SendNotification(NotifyName.HideUI, ViewList.GiftPackNewYearView)
    ModelList.GiftPackModel:CloseView()
end

function GiftPackNewYearView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackNewYearView:OnBuySuccess(needClose,itemData)
...
function GiftPackNewYearView:showGetRewardEffect(itemData,isFree)
...
function GiftPackNewYearView:SetTimer()
...
--领取成功
function GiftPackNewYearView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackNewYearView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackNewYearView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackNewYearView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
