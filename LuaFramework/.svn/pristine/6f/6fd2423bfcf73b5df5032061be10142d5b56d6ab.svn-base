...
local GiftPackMemorialDayView = GiftPackBaseView:New('GiftPackMemorialDayView', "GiftPackMemorialDayViewAtlas")
local this = GiftPackMemorialDayView
...
function GiftPackMemorialDayView:Awake(obj)
    self:on_init()
    self._isInit = true
    --- �޸����ֻ����״ν�����治��ʾ����
...
function GiftPackMemorialDayView:OnEnable()
    self:BuildFsm(self)
    self:Bi_Tracker()
    UISound.play("sale_flagday")
end

function GiftPackMemorialDayView:OnDisable()
...
function GiftPackMemorialDayView:ClearCountDown()
...
function GiftPackMemorialDayView:CloseUIShiny(obj)
...
function GiftPackMemorialDayView:on_btn_buy1_click()
...
function GiftPackMemorialDayView:GetLastClickTime(pos)
    return clickTimeList or 0
end

function GiftPackMemorialDayView:on_btn_buy2_click()
    if self._fsm:GetCurName() ~= "GiftPackEnterState" then return end
...
function GiftPackMemorialDayView:SetExtra(extraUI,extraParent , bonus)
...
function GiftPackMemorialDayView:SetItemGrid(itemId, itemNum , itemGrid)
...
function GiftPackMemorialDayView:ShowItemGrid()
...
function GiftPackMemorialDayView:SetItem(itemUI,id, pos, btn)
...
function GiftPackMemorialDayView:GetItemGrid(pos,index,prefab, parent)
...
function GiftPackMemorialDayView:HideGridItem()
    for k ,v in pairs(itemList) do
        for z,w in pairs(v) do
            if w then
...
function GiftPackMemorialDayView:ShowDetailGift()
...
function GiftPackMemorialDayView:SetButton(button, id,pos)
...
function GiftPackMemorialDayView:SetLeftTime(endTimeStamp)
...
function GiftPackMemorialDayView:CollectProduct(pId,giftInfo)
    product_list = {}
...
function GiftPackMemorialDayView:on_close()
    --Event.Brocast(Notes.CARD_COLLIDER_OPEN, true)
end

function GiftPackMemorialDayView:CloseFunc()
    Facade.SendNotification(NotifyName.HideDialog, self)
end

function GiftPackMemorialDayView:ClosePackView()
...
function GiftPackMemorialDayView:on_btn_close_click()
    self:ClosePackView()
end

function  GiftPackMemorialDayView:OnBuySuccess(needClose,itemData)
    self:ChangeState(self,"GiftPackShowState",itemData)
end

function  GiftPackMemorialDayView:GetGiftPos(id)
...
function GiftPackMemorialDayView:GetItemPos(pos)
    local posTable ={}
