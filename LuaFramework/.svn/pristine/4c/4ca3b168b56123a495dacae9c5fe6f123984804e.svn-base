...
---@class  CandyHallViewGuide : ApplicationGuideInfo
local CandyHallViewGuide = ApplicationGuideInfo:New()
local this = CandyHallViewGuide

function CandyHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("CandyHallViewGuide:Init")
end
...
function CandyHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("CandyHallViewGuide:Remove")
    this:UnRegister()
end

function CandyHallViewGuide:DelayCheck()
    RemoveDelay()
...
function CandyHallViewGuide:Check()
...
function CandyHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
