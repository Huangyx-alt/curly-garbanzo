...
require "View/HallCity/ScratchWinnerConsoleView"
ScratchWinnerFunctionContainer = HallFunctionContainer:New()

function ScratchWinnerFunctionContainer:Init()
    ...
    self._jackpotConsole = ScratchWinnerConsoleView:New(JackepotHost.mainLobby)
