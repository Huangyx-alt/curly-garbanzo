...
this.atlasName = "HorseRacingPassTaskAtlas"
this.longTaskAtlasName = "HorseRacingPassTaskAtlas"
...
function PassTaskView:OnEnable(params)
    ...
    --- flag:短令牌 每次增加新的短令牌都要修改
    if not ModelList.GuideModel:IsGuideComplete(79) then
        ModelList.GuideModel:TriggerPassTaskView(572)
    end
end
