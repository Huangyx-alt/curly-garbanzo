...
---@class CmdPlaySkill103 : CommandBase
local CmdPlaySkill103 = BaseClass("CmdPlaySkill103", base)
local CommandConst = CommandConst
local this = CmdPlaySkill103

function CmdPlaySkill103:OnCmdExecute(args)
    args = args or {}
...
function CmdPlaySkill103:ShowFly(mapObj, cellObj, cardID, targetCellIndex, powerId, cellIndex)
    local targetCell = this.cardView:GetCardCell(tonumber(cardID), targetCellIndex)
    local prefabName = "DrinkingFrenzyskill2feiji"
...
--控制起始角度和结束角度
function CmdPlaySkill103:GetOffsetDir(startPos, endPos)
...
function CmdPlaySkill103:GetBeizerList(pathNodes, segmentNum)
    local path = {}
...
---@param p2 table 控制点2
---@param p3 table 终点
function CmdPlaySkill103:CalculateCubicBezierPoint(t, p0, p1, p2, p3)
    local arg1 = 1 - t
