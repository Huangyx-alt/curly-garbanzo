...
--- 夏威夷单张卡牌
local LeetoleManSingleCardView = BaseSingleCard:New();
local this = LeetoleManSingleCardView;
...
function LeetoleManSingleCardView:OnEnable(params)

end

function LeetoleManSingleCardView:OnDisable()
    
end

function LeetoleManSingleCardView:BindObj(obj,parentView)
...
function LeetoleManSingleCardView:Clone(name)
    local o ={name = name}
    setmetatable(o,self)
    self.__index = self
    return o
...
function LeetoleManSingleCardView:AddBowlDrink(bowlTable,cardId,bowlType,addCount)
    if bowlType == 1 then
...
function LeetoleManSingleCardView:ForbidCollider()
    if self.forbidCollide then
        fun.set_active(self.forbidCollide,true)
    end
end

function LeetoleManSingleCardView:PlayLeeToleManAction(callback)
    self.leetouman:SetAnimation("throw",callback,false,0)
    self.leetouman:AddAnimation("idle",nil,true,0)
end

function LeetoleManSingleCardView:PlayLeeToleManEmpty(callback)
    if self.leetouman:IsCurrentPlay("idle") then
        self.leetouman:SetAnimation("sad",callback,false,0)
        self.leetouman:AddAnimation("idle",nil,true,0)
    end
end

function LeetoleManSingleCardView:PlayLeeToleManBingoAction(callback)
    self.leetouman:SetAnimation("bingo",callback,false,0)
    self.leetouman:AddAnimation("idle",nil,true,0)
end
