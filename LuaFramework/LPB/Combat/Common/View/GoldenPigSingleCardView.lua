...
local GoldenPigSingleCardView = BaseSingleCard:New();
local this = GoldenPigSingleCardView;
...
function GoldenPigSingleCardView:OnEnable(params)

end

function GoldenPigSingleCardView:OnDisable()

end

function GoldenPigSingleCardView:BindObj(obj, parentView)
    self:on_init(obj, parentView)
end

function GoldenPigSingleCardView:Clone(name)
    local o = { name = name }
    setmetatable(o, self)
    self.__index = self
    return o
...
function GoldenPigSingleCardView:AddBowlDrink(bowlTable, cardId, bowlType, addCount)
...
function GoldenPigSingleCardView:ForbidCollider()
