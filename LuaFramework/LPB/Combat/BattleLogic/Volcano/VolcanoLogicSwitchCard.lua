...
local VolcanoLogicSwitchCard = BaseSwitchCardLogic:New("VolcanoLogicSwitchCard")
local this = VolcanoLogicSwitchCard
this.moduleName = "VolcanoLogicSwitchCard"

function VolcanoLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function VolcanoLogicSwitchCard:StartSwitchCard()
...
function VolcanoLogicSwitchCard:IsShowing(cardId)
...
function VolcanoLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function VolcanoLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function VolcanoLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.VolcanoModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function VolcanoLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function VolcanoLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function VolcanoLogicSwitchCard:GetsCurrCardOrder()
