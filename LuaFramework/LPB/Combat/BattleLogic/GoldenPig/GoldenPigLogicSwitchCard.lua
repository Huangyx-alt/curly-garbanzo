...
local GoldenPigLogicSwitchCard = BaseSwitchCardLogic:New("GoldenPigLogicSwitchCard")
local this = GoldenPigLogicSwitchCard
this.moduleName = "GoldenPigLogicSwitchCard"

function GoldenPigLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function GoldenPigLogicSwitchCard:StartSwitchCard()
...
function GoldenPigLogicSwitchCard:IsShowing(cardId)
...
function GoldenPigLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function GoldenPigLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function GoldenPigLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.GoldenPigModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function GoldenPigLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function GoldenPigLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function GoldenPigLogicSwitchCard:GetsCurrCardOrder()
