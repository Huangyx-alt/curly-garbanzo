...
local HorseRacingLogicSwitchCard = BaseSwitchCardLogic:New("HorseRacingLogicSwitchCard")
local this = HorseRacingLogicSwitchCard
this.moduleName = "HorseRacingLogicSwitchCard"

function HorseRacingLogicSwitchCard:InitLogic()
...
--- �л�����
function HorseRacingLogicSwitchCard:StartSwitchCard()
...
function HorseRacingLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function HorseRacingLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function HorseRacingLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function HorseRacingLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.HorseRacingModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function HorseRacingLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function HorseRacingLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function HorseRacingLogicSwitchCard:GetsCurrCardOrder()
