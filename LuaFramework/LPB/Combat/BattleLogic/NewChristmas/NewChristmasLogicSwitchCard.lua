...
local NewChristmasLogicSwitchCard = BaseSwitchCardLogic:New("NewChristmasLogicSwitchCard")
local this = NewChristmasLogicSwitchCard
this.moduleName = "NewChristmasLogicSwitchCard"

function NewChristmasLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function NewChristmasLogicSwitchCard:StartSwitchCard()
...
function NewChristmasLogicSwitchCard:IsShowing(cardId)
...
function NewChristmasLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function NewChristmasLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function NewChristmasLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.NewChristmasModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function NewChristmasLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function NewChristmasLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function NewChristmasLogicSwitchCard:GetsCurrCardOrder()
