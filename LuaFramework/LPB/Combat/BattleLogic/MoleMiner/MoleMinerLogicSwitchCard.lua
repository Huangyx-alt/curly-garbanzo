...
local MoleMinerLogicSwitchCard = BaseSwitchCardLogic:New("MoleMinerLogicSwitchCard")
local this = MoleMinerLogicSwitchCard
this.moduleName = "MoleMinerLogicSwitchCard"

function MoleMinerLogicSwitchCard:InitLogic()
...
--- �л�����
function MoleMinerLogicSwitchCard:StartSwitchCard()
...
function MoleMinerLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function MoleMinerLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function MoleMinerLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function MoleMinerLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.MoleMinerModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function MoleMinerLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function MoleMinerLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function MoleMinerLogicSwitchCard:GetsCurrCardOrder()
