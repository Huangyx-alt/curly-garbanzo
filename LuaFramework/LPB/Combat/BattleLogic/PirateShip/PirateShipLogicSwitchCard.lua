...
local PirateShipLogicSwitchCard = BaseSwitchCardLogic:New("PirateShipLogicSwitchCard")
local this = PirateShipLogicSwitchCard
this.moduleName = "PirateShipLogicSwitchCard"

function PirateShipLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function PirateShipLogicSwitchCard:StartSwitchCard()
...
function PirateShipLogicSwitchCard:IsShowing(cardId)
...
function PirateShipLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function PirateShipLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function PirateShipLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.PirateShipModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function PirateShipLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function PirateShipLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function PirateShipLogicSwitchCard:GetsCurrCardOrder()
