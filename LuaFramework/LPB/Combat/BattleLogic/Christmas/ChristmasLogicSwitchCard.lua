...
local  ChristmasLogicSwitchCard = BaseSwitchCardLogic:New("ChristmasLogicSwitchCard")
local this = ChristmasLogicSwitchCard
this.moduleName = "ChristmasLogicSwitchCard"

function ChristmasLogicSwitchCard:InitLogic()
...
--- 切换卡牌
function ChristmasLogicSwitchCard:StartSwitchCard()
...
--- 是否正在台前展示
function ChristmasLogicSwitchCard:IsShowing(cardId)
...
--- 开始前后两个Jackpot卡切换到一起
function ChristmasLogicSwitchCard:EnterDoubleJackpotChangeCard()
...
--- 结束前后两个Jackpot卡切换到一起
function ChristmasLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- 有Jackpot的卡牌自动移动到后面
function ChristmasLogicSwitchCard:StartHideJackpotCardBackground(currCardId,otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5,0.3,-1,function()
        if ModelList.ChristmasGameModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function ChristmasLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function ChristmasLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end


function ChristmasLogicSwitchCard:GetsCurrCardOrder()
