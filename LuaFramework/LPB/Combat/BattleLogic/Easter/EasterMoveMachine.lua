...
local EasterAStar = require("Combat.BattleLogic.Easter.EasterAStar")

---  复活节玩法寻路移动
local EasterMoveMachine = {}
local this = EasterMoveMachine
this.normalSpeed = 2
this.quickSpeed = 2
this.curStayCell = {}
    ...
    table.each(treasureQueue, function(cellIndexList, cardID)
        ...
        table.each(cellIndexList, function(v)
            ...
            if cellData and not cellData.isGained then
                local aStar = CreateInstance_(EasterAStar)
