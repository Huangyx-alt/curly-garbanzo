...
local GoldenTrainLogicSwitchCard = BaseSwitchCardLogic:New("GoldenTrainLogicSwitchCard")
local this = GoldenTrainLogicSwitchCard
this.moduleName = "GoldenTrainLogicSwitchCard"

function GoldenTrainLogicSwitchCard:InitLogic()
...
--- �л�����
function GoldenTrainLogicSwitchCard:StartSwitchCard()
...
function GoldenTrainLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function GoldenTrainLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function GoldenTrainLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function GoldenTrainLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.GoldenTrainModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function GoldenTrainLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function GoldenTrainLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function GoldenTrainLogicSwitchCard:GetsCurrCardOrder()
