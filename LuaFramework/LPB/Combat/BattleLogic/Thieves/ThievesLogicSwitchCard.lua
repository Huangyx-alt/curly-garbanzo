...
local ThievesLogicSwitchCard = BaseSwitchCardLogic:New("ThievesLogicSwitchCard")
local this = ThievesLogicSwitchCard
this.moduleName = "ThievesLogicSwitchCard"

function ThievesLogicSwitchCard:InitLogic()
...
--- 切换卡牌
function ThievesLogicSwitchCard:StartSwitchCard()
...
function ThievesLogicSwitchCard:IsShowing(cardId)
...
--- 切换卡牌
function ThievesLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
        log.r("正在切换卡牌，不应该触发双jackpot切卡")
    end
    self.isSwitching = true
...
function ThievesLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- 有Jackpot的卡牌自动移动到后面
function ThievesLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
...
---
function ThievesLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function ThievesLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function ThievesLogicSwitchCard:GetsCurrCardOrder()
