...
local LetemRollLogicSwitchCard = BaseSwitchCardLogic:New("LetemRollLogicSwitchCard")
local this = LetemRollLogicSwitchCard
this.moduleName = "LetemRollLogicSwitchCard"

function LetemRollLogicSwitchCard:InitLogic()
...
--- �л�����
function LetemRollLogicSwitchCard:StartSwitchCard()
...
function LetemRollLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function LetemRollLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function LetemRollLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function LetemRollLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.LetemRollModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function LetemRollLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function LetemRollLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function LetemRollLogicSwitchCard:GetsCurrCardOrder()
