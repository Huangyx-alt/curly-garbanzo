...
local SolitaireLogicSwitchCard = BaseSwitchCardLogic:New("SolitaireLogicSwitchCard")
local this = SolitaireLogicSwitchCard
this.moduleName = "SolitaireLogicSwitchCard"

function SolitaireLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function SolitaireLogicSwitchCard:StartSwitchCard()
...
function SolitaireLogicSwitchCard:IsShowing(cardId)
...
function SolitaireLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function SolitaireLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function SolitaireLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.SolitaireModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function SolitaireLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function SolitaireLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function SolitaireLogicSwitchCard:GetsCurrCardOrder()
