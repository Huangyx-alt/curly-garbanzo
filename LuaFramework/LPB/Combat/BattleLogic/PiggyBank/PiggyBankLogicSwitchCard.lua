...
local PiggyBankLogicSwitchCard = BaseSwitchCardLogic:New("PiggyBankLogicSwitchCard")
local this = PiggyBankLogicSwitchCard
this.moduleName = "PiggyBankLogicSwitchCard"

function PiggyBankLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function PiggyBankLogicSwitchCard:StartSwitchCard()
...
function PiggyBankLogicSwitchCard:IsShowing(cardId)
...
function PiggyBankLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function PiggyBankLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function PiggyBankLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.PiggyBankModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function PiggyBankLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function PiggyBankLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function PiggyBankLogicSwitchCard:GetsCurrCardOrder()
