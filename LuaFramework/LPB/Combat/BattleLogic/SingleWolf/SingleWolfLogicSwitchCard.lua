...
local  SingleWolfLogicSwitchCard = BaseSwitchCardLogic:New("SingleWolfLogicSwitchCard")
local this = SingleWolfLogicSwitchCard
this.moduleName = "SingleWolfLogicSwitchCard"

function SingleWolfLogicSwitchCard:InitLogic()
...
--- 切换卡牌
function SingleWolfLogicSwitchCard:StartSwitchCard()
...
function SingleWolfLogicSwitchCard:IsShowing(cardId)
...
--- 切换卡牌
function SingleWolfLogicSwitchCard:EnterDoubleJackpotChangeCard()
...
function SingleWolfLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- 有Jackpot的卡牌自动移动到后面
function SingleWolfLogicSwitchCard:StartHideJackpotCardBackground(currCardId,otherJackpotId)
...
---
function SingleWolfLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function SingleWolfLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function SingleWolfLogicSwitchCard:GetsCurrCardOrder()
