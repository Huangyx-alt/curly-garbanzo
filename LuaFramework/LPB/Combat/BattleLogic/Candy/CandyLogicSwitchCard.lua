...
local CandyLogicSwitchCard = BaseSwitchCardLogic:New("CandyLogicSwitchCard")
local this = CandyLogicSwitchCard
this.moduleName = "CandyLogicSwitchCard"

function CandyLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function CandyLogicSwitchCard:StartSwitchCard()
...
function CandyLogicSwitchCard:IsShowing(cardId)
...
function CandyLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function CandyLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function CandyLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.CandyModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function CandyLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function CandyLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function CandyLogicSwitchCard:GetsCurrCardOrder()
