...
local NewLeetoleManLogicSwitchCard = BaseSwitchCardLogic:New("NewLeetoleManLogicSwitchCard")
local this = NewLeetoleManLogicSwitchCard
this.moduleName = "NewLeetoleManLogicSwitchCard"

function NewLeetoleManLogicSwitchCard:InitLogic()
    self.__index:InitLogic()
    self.PageOneCardIds = { 1, 2 }
    self.BackTwoCardIds = { 3, 4 }
end

function NewLeetoleManLogicSwitchCard:StartSwitchCard()
...
function NewLeetoleManLogicSwitchCard:IsShowing(cardId)
...
function NewLeetoleManLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function NewLeetoleManLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
function NewLeetoleManLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.NewLeetoleManModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
function NewLeetoleManLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function NewLeetoleManLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function NewLeetoleManLogicSwitchCard:GetsCurrCardOrder()
