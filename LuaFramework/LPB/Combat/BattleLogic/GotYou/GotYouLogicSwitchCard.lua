...
local GotYouLogicSwitchCard = BaseSwitchCardLogic:New("GotYouLogicSwitchCard")
local this = GotYouLogicSwitchCard
this.moduleName = "GotYouLogicSwitchCard"

function GotYouLogicSwitchCard:InitLogic()
...
--- �л�����
function GotYouLogicSwitchCard:StartSwitchCard()
...
function GotYouLogicSwitchCard:IsShowing(cardId)
...
--- �л�����
function GotYouLogicSwitchCard:EnterDoubleJackpotChangeCard()
    if self.isSwitching then
...
function GotYouLogicSwitchCard:ExitDoubleJackpotChangeCard()
...
--- ��Jackpot�Ŀ����Զ��ƶ�������
function GotYouLogicSwitchCard:StartHideJackpotCardBackground(currCardId, otherJackpotId)
    self.loopMoveCard = LuaTimer:SetDelayLoopFunction(5, 0.3, -1, function()
        if ModelList.GotYouModel:IsGameOver() then
            self:RemoveHideJackpotCardBackground()
            return
        end
...
---
function GotYouLogicSwitchCard:RemoveHideJackpotCardBackground()
...
function GotYouLogicSwitchCard:OnDisable()
    self:RemoveHideJackpotCardBackground()
end

function GotYouLogicSwitchCard:GetsCurrCardOrder()
