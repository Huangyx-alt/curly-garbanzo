...
---@class  BisonHallViewGuide : ApplicationGuideInfo
local BisonHallViewGuide = ApplicationGuideInfo:New()
local this = BisonHallViewGuide

function BisonHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("BisonHallViewGuide:Init")
end
...
function BisonHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("BisonHallViewGuide:Remove")
    this:UnRegister()
end

function BisonHallViewGuide:DelayCheck()
    RemoveDelay()
...
function BisonHallViewGuide:Check()
...
function BisonHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
