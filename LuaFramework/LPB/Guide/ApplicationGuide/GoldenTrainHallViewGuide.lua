...
---@class  GoldenTrainHallViewGuide : ApplicationGuideInfo
local GoldenTrainHallViewGuide = ApplicationGuideInfo:New()
local this = GoldenTrainHallViewGuide

function GoldenTrainHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("GoldenTrainHallViewGuide:Init")
end
...
function GoldenTrainHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("GoldenTrainHallViewGuide:Remove")
    this:UnRegister()
end

function GoldenTrainHallViewGuide:DelayCheck()
    RemoveDelay()
...
function GoldenTrainHallViewGuide:Check()
...
function GoldenTrainHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function GoldenTrainHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function GoldenTrainHallViewGuide:UnRegister()
