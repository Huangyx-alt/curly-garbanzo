...
---@class  NewLeetoleManHallViewGuide : ApplicationGuideInfo
local NewLeetoleManHallViewGuide = ApplicationGuideInfo:New()
local this = NewLeetoleManHallViewGuide

function NewLeetoleManHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("NewLeetoleManHallViewGuide:Init")
end
...
function NewLeetoleManHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("NewLeetoleManHallViewGuide:Remove")
    this:UnRegister()
end

function NewLeetoleManHallViewGuide:DelayCheck()
    RemoveDelay()
...
function NewLeetoleManHallViewGuide:Check()
...
function NewLeetoleManHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function NewLeetoleManHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function NewLeetoleManHallViewGuide:UnRegister()
