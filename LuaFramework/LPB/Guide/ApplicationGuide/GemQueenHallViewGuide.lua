...
---@class  GemQueenHallViewGuide : ApplicationGuideInfo
local GemQueenHallViewGuide = ApplicationGuideInfo:New()
local this = GemQueenHallViewGuide

function GemQueenHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("GemQueenHallViewGuide:Init")
end
...
function GemQueenHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("GemQueenHallViewGuide:Remove")
    this:UnRegister()
end

function GemQueenHallViewGuide:DelayCheck()
    RemoveDelay()
...
function GemQueenHallViewGuide:Check()
...
function GemQueenHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function GemQueenHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function GemQueenHallViewGuide:UnRegister()
