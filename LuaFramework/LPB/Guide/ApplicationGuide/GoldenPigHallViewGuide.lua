...
---@class  GoldenPigHallViewGuide : ApplicationGuideInfo
local GoldenPigHallViewGuide = ApplicationGuideInfo:New()
local this = GoldenPigHallViewGuide

function GoldenPigHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("GoldenPigHallViewGuide:Init")
end
...
function GoldenPigHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("GoldenPigHallViewGuide:Remove")
    this:UnRegister()
end

function GoldenPigHallViewGuide:DelayCheck()
    RemoveDelay()
...
function GoldenPigHallViewGuide:Check()
...
function GoldenPigHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function GoldenPigHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function GoldenPigHallViewGuide:UnRegister()
