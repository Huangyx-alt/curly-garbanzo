...
---@class  HorseRacingHallViewGuide : ApplicationGuideInfo
local HorseRacingHallViewGuide = ApplicationGuideInfo:New()
local this = HorseRacingHallViewGuide

function HorseRacingHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("HorseRacingHallViewGuide:Init")
end
...
function HorseRacingHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("HorseRacingHallViewGuide:Remove")
    this:UnRegister()
end

function HorseRacingHallViewGuide:DelayCheck()
    RemoveDelay()
...
function HorseRacingHallViewGuide:Check()
...
function HorseRacingHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function HorseRacingHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function HorseRacingHallViewGuide:UnRegister()
