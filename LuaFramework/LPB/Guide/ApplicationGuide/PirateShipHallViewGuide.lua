...
---@class  PirateShipHallViewGuide : ApplicationGuideInfo
local PirateShipHallViewGuide = ApplicationGuideInfo:New()
local this = PirateShipHallViewGuide

function PirateShipHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("PirateShipHallViewGuide:Init")
end
...
function PirateShipHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("PirateShipHallViewGuide:Remove")
    this:UnRegister()
end

function PirateShipHallViewGuide:DelayCheck()
    RemoveDelay()
...
function PirateShipHallViewGuide:Check()
...
function PirateShipHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function PirateShipHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function PirateShipHallViewGuide:UnRegister()
