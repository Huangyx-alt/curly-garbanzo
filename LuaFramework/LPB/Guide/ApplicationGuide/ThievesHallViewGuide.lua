...
---@class  ThievesHallViewGuide : ApplicationGuideInfo
local ThievesHallViewGuide = ApplicationGuideInfo:New()
local this = ThievesHallViewGuide

function ThievesHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("ThievesHallViewGuide:Init")
end
...
function ThievesHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil,true,nil,true)
    log.r("ThievesHallViewGuide:Remove")
    this:UnRegister()
end

function ThievesHallViewGuide:DelayCheck()
    RemoveDelay()
...
function ThievesHallViewGuide:Check()
...
function ThievesHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function ThievesHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function ThievesHallViewGuide:UnRegister()
