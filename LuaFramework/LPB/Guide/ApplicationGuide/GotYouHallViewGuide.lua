...
---@class  GotYouHallViewGuide : ApplicationGuideInfo
local GotYouHallViewGuide = ApplicationGuideInfo:New()
local this = GotYouHallViewGuide

function GotYouHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("GotYouHallViewGuide:Init")
end
...
function GotYouHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil, true, nil, true)
    log.r("GotYouHallViewGuide:Remove")
    this:UnRegister()
end

function GotYouHallViewGuide:DelayCheck()
    RemoveDelay()
...
function GotYouHallViewGuide:Check()
...
function GotYouHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
