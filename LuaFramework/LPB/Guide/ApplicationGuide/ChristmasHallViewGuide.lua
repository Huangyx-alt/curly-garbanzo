...
---@class  ChristmasHallViewGuide : ApplicationGuideInfo
local ChristmasHallViewGuide = ApplicationGuideInfo:New()
local this = ChristmasHallViewGuide

function ChristmasHallViewGuide:Init()
    this:Register()
    this:DelayCheck()
    log.r("ChristmasHallViewGuide:Init")
end
...
function ChristmasHallViewGuide:Remove()
    --this:Register()
    RemoveDelay()
    this:PlayFingerEffect(nil,true,nil,true)
    log.r("ChristmasHallViewGuide:Remove")
    this:UnRegister()
end

function ChristmasHallViewGuide:DelayCheck()
    RemoveDelay()
...
function ChristmasHallViewGuide:Check()
...
function ChristmasHallViewGuide:DelayShowFinger(isStart)
    if isStart then
        if this.delay_show then
            LuaTimer:Remove(this.delay_show)
            this.delay_show = nil
...
function ChristmasHallViewGuide:Register()
    Event.AddListener(EventName.ApplicationGuide_ResetFinger, this.DelayShowFinger)
end

function ChristmasHallViewGuide:UnRegister()
