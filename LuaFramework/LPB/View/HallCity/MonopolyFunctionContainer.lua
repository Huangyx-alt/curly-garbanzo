...
local MonopolyConsoleView = require "View/HallCity/MonopolyConsoleView"
MonopolyFunctionContainer = HallFunctionContainer:New()

function MonopolyFunctionContainer:Init()
    ...
    self._jackpotConsole = MonopolyConsoleView:New(JackepotHost.mainLobby)
