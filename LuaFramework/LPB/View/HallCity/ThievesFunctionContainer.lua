...
require "View/HallCity/ThievesConsoleView"

ThievesFunctionContainer = HallFunctionContainer:New()

function ThievesFunctionContainer:Init()
    ...
    self._jackpotConsole = ThievesConsoleView:New(JackepotHost.mainLobby)
