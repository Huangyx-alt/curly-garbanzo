...
local PiggyBankConsoleView = require "View/HallCity/PiggyBankConsoleView"
PiggyBankFunctionContainer = HallFunctionContainer:New()

function PiggyBankFunctionContainer:Init()
    ...
    self._jackpotConsole = PiggyBankConsoleView:New(JackepotHost.mainLobby)
