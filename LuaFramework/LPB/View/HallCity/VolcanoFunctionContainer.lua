...
require "View/HallCity/VolcanoConsoleView"
VolcanoFunctionContainer = HallFunctionContainer:New()

function VolcanoFunctionContainer:Init()
    ...
    self._jackpotConsole = VolcanoConsoleView:New(JackepotHost.mainLobby)
