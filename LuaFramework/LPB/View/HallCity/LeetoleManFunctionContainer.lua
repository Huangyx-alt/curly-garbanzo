...
require "View/HallCity/LeetoleManConsoleView"

LeetoleManFunctionContainer = HallFunctionContainer:New()

function LeetoleManFunctionContainer:Init()
    ...
    self._jackpotConsole = LeetoleManConsoleView:New(JackepotHost.mainLobby)
