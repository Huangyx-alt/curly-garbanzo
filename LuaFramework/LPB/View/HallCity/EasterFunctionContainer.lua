...
require "View/HallCity/EasterConsoleView"
EasterFunctionContainer = HallFunctionContainer:New()

function EasterFunctionContainer:Init()
    ...
    self._jackpotConsole = EasterConsoleView:New(JackepotHost.mainLobby)
