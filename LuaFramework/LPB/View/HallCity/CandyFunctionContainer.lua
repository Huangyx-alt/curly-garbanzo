...
require "View/HallCity/CandyConsoleView"
CandyFunctionContainer = HallFunctionContainer:New()

function CandyFunctionContainer:Init()
    ...
    self._jackpotConsole = CandyConsoleView:New(JackepotHost.mainLobby)
