...
local HallofFameGoldRewardView = BaseView:New("HallofFameGoldRewardView","TournamentAtlas")
local this = HallofFameGoldRewardView
...
function HallofFameGoldRewardView:Awake(obj)
	self:on_init()
end

function HallofFameGoldRewardView:GetCsvData()
	return Csv.weekly_list_gold
end

function HallofFameGoldRewardView:OnEnable()
	self:SetKey()
	Facade.RegisterView(self)
	CommonState.BuildFsm(self,"HallofFameGoldRewardView")
...
function HallofFameGoldRewardView:OnDisable()
	keyTable = {}
	Facade.RemoveView(self)
	CommonState.DisposeFsm(self)
end

function HallofFameGoldRewardView:on_btn_close_click()
	self._fsm:GetCurState():DoOriginalAction(self._fsm,"CommonState1State",function()
...
function HallofFameGoldRewardView:CheckRanking(rankingList)
...
function HallofFameGoldRewardView:SetReward()
...
function HallofFameGoldRewardView:SetKey()
	keyTable = {}
...
function HallofFameGoldRewardView:GetKey(id)
