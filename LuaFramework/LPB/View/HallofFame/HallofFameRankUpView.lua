...
--- DateTime: 2024/4/9 16:44
---

local HallofFameRankUpView = {}
...
function HallofFameRankUpView:OnDestroy()
...
function HallofFameRankUpView:OnDisable()
    creatTopOneItem = {};
    creatMyNewRewardItem = {};
end

function HallofFameRankUpView:OnEnable(params)
...
function HallofFameRankUpView:InitView()
    --self:SetTrophyName();
...
function HallofFameRankUpView:InitMyNewReward()
...
function HallofFameRankUpView:GetGride(prefab,parent,list,index)
    local grid = list[index];
    if grid == nil then
        grid = fun.get_instance(prefab, parent)
        table.insert(list, grid);
    end
    log.e("HallofFameRankUpView grid:")
    return grid;
end

function HallofFameRankUpView:InitTopOneReward()
...
function HallofFameRankUpView:GetItemUiData(totalNum , index)
