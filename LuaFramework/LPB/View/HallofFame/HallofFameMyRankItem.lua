...
local HallofFameMyRankItem = HallofFameRankItem:New()
local this = HallofFameMyRankItem
...
function HallofFameMyRankItem:Awake()
    self:on_init()
end

function HallofFameMyRankItem:OnDispose()
    reward_item = nil
end

function HallofFameMyRankItem:IsMyRank()
    return true
end

function HallofFameMyRankItem:RequestPlayerTournamentInfo()
    --点击自己不弹出玩家信息
end

function HallofFameMyRankItem:GetHeadIcon()
    return fun.get_strNoEmpty(ModelList.PlayerInfoModel:GetHeadIcon(), "xxl_head016")
end

function HallofFameMyRankItem:SetRewardItem(tiers,difficulty,order)
...
function HallofFameMyRankItem:GetBuffPosParams()
    local params = {}
