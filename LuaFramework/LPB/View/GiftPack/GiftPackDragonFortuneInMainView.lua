...
local GiftPackDragonFortuneInMainView = GiftPackBaseView:New('GiftPackDragonFortuneInMainView', "GiftPackNewYearAtlas")
local this = GiftPackDragonFortuneInMainView
...
function GiftPackDragonFortuneInMainView:Awake(obj)
    self:on_init()
...
function GiftPackDragonFortuneInMainView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackDragonFortuneInMainView:OnDisable()
...
function GiftPackDragonFortuneInMainView:ClearCountDown()
...
function GiftPackDragonFortuneInMainView:ShowItemGrid()
...
function GiftPackDragonFortuneInMainView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackDragonFortuneInMainView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackDragonFortuneInMainView:ClearMailList()
...
function GiftPackDragonFortuneInMainView:GetItemViewInstance(index)
...
function GiftPackDragonFortuneInMainView:ShowDetailGift()
...
function GiftPackDragonFortuneInMainView:SetLeftTime(endTimeStamp)
...
function GiftPackDragonFortuneInMainView:OnDestroy()
    log.g("GiftPackDragonFortuneInMainView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackDragonFortuneInMainView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackDragonFortuneInMainView:ClosePackView()
...
function GiftPackDragonFortuneInMainView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackDragonFortuneInMainView:OnBuySuccess(needClose,itemData)
...
function GiftPackDragonFortuneInMainView:showGetRewardEffect(itemData,isFree)
...
function GiftPackDragonFortuneInMainView:SetTimer()
...
--领取成功
function GiftPackDragonFortuneInMainView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackDragonFortuneInMainView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackDragonFortuneInMainView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackDragonFortuneInMainView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
