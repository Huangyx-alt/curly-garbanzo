...
local GiftPackEasterWView = GiftPackBaseView:New('GiftPackEasterWView')
local this = GiftPackEasterWView
...
function GiftPackEasterWView:Awake(obj)
    self:on_init()
...
function GiftPackEasterWView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackEasterWView:OnDisable()
...
function GiftPackEasterWView:ClearCountDown()
...
function GiftPackEasterWView:ShowItemGrid()
...
function GiftPackEasterWView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackEasterWView:movetoGrid(step,tflag)
    step = step or 1
...
function GiftPackEasterWView:ClearMailList()
...
function GiftPackEasterWView:GetItemViewInstance(index)
...
function GiftPackEasterWView:ShowDetailGift()
...
function GiftPackEasterWView:SetLeftTime(endTimeStamp)
...
function GiftPackEasterWView:OnDestroy()
    log.g("GiftPackEasterWView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackEasterWView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackEasterWView:ClosePackView()
...
function GiftPackEasterWView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackEasterWView:OnBuySuccess(needClose,itemData)
...
function GiftPackEasterWView:showGetRewardEffect(itemData,isFree)
...
function GiftPackEasterWView:SetTimer()
...
--领取成功
function GiftPackEasterWView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackEasterWView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackEasterWView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackEasterWView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
