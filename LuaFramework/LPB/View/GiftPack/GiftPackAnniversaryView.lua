...
local GiftPackAnniversaryView = GiftPackBaseView:New('GiftPackAnniversaryView')
local this = GiftPackAnniversaryView
...
function GiftPackAnniversaryView:Awake(obj)
    self:on_init()
    self._isInit = true
    --- 修复部分机型首次进入界面不显示问题
...
function GiftPackAnniversaryView:BuildFsm(owner)
    FsmCreator:Create("GiftPackAnniversaryView",owner,{
...
function GiftPackAnniversaryView:OnEnable()
...
function GiftPackAnniversaryView:OnDisable()
...
function GiftPackAnniversaryView:CleanChildView()
...
function GiftPackAnniversaryView:ShowDetailGift()
...
function GiftPackAnniversaryView:ShowItemGrid()
    data = ModelList.GiftPackModel:GetShowGiftPack()
    log.r("lxq GiftPackAnniversaryView",data)
    self:CollectProduct(data.pId,data.giftInfo) 
    self:InitShopItem()
end
 

function GiftPackAnniversaryView:CleanShopItem()
...
function GiftPackAnniversaryView:InitShopItemPos()
...
function GiftPackAnniversaryView:InitShopItem()
    self:CleanShopItem()
...
function GiftPackAnniversaryView:ClearCountDown()
...
function GiftPackAnniversaryView:CloseUIShiny(obj)
...
function GiftPackAnniversaryView:on_btn_up_buy_click()
...
function GiftPackAnniversaryView:GetLastClickTime(pos)
    return clickTimeList or 0
end


function GiftPackAnniversaryView:SetItemGrid(itemId, itemNum , itemGrid)
...
function GiftPackAnniversaryView:SetItem(itemUI,id, pos, btn)
...
function GiftPackAnniversaryView:GetItemGrid(pos,index,prefab, parent)
...
function GiftPackAnniversaryView:HideGridItem()
...
function GiftPackAnniversaryView:SetButton(button, id,pos)
...
function GiftPackAnniversaryView:SetLeftTime(endTimeStamp)
...
function GiftPackAnniversaryView:CollectProduct(pId,giftInfo)
    product_list = {}
...
function GiftPackAnniversaryView.OnDestroy()
    this:Destroy()
end

function GiftPackAnniversaryView:on_close()
    --Event.Brocast(Notes.CARD_COLLIDER_OPEN, true)
end

function GiftPackAnniversaryView:CloseFunc()
    Facade.SendNotification(NotifyName.HideDialog, this)
end

function GiftPackAnniversaryView:ClosePackView()
...
function GiftPackAnniversaryView:on_btn_close_click()
    self:ClosePackView()
end

function  GiftPackAnniversaryView:OnBuySuccess(needClose,itemData)
...
function  GiftPackAnniversaryView:GetGiftPos(id)
...
function GiftPackAnniversaryView:SetItemVisiable(giftPackSweetmeatsItemView,visiable)
...
function GiftPackAnniversaryView:GetItemPos(pos)
     return self.fullItemPos[pos]
end

function GiftPackAnniversaryView:GetItemViewInstance(index)
...
function GiftPackAnniversaryView:GetLocalGiftData()
...
function GiftPackAnniversaryView:ShowItemGridData(step,isShow)
    local count = 0
    local tempData = ModelList.GiftPackModel:GetShowGiftPack()
...
function GiftPackAnniversaryView:FullItemGridData(step,view,pos)
    local tempData = ModelList.GiftPackModel:GetShowGiftPack()
    local tmpData =self:GetLocalGiftData()
    local count = 0 
    for _,v in ipairs(tmpData) do 
...
--查询成功
function GiftPackAnniversaryView.OnFetchEndlessGiftSuccess(data)
...
function GiftPackAnniversaryView.TestMove()
...
function GiftPackAnniversaryView:MoveItem(step) 
    if(isMoveing)then 
        return 
    end
    isMoveing = true 
...
function GiftPackAnniversaryView:MoveToLast(view)
    local pos = 6
    local i = 6
    while i>1 do
...
function GiftPackAnniversaryView:MoveAllItem(flyTime,delay) 
    local delayCout = 0 
    for i=1,5 do
...
function GiftPackAnniversaryView:SetViewByPos(view,pos)
    ItemEntityCache[pos] = view
end
function GiftPackAnniversaryView:HideAllItemDir()
    for k,v in pairs(ItemEntityCache) do
        v:SetDirection(7)  --隐藏所有方向 
    end
end
function GiftPackAnniversaryView:ShowAllItemDir()
    local islastPos = 1
    local isFull = true 
    for k,v in pairs(ItemEntityCache) do
...
function GiftPackAnniversaryView:RemoveItemViewByPos(index)
...
function GiftPackAnniversaryView:on_btn_up_Free_click() --免费的
...
function GiftPackAnniversaryView:showGetRewardEffect(itemData,isFree)
...
function GiftPackAnniversaryView:CheckAutoClose()
...
--领取成功
function GiftPackAnniversaryView.OnClaimEndlessGiftSuccess(data)
 
 
    local tmpdata  ={ itemData = data.reward,step = data.step}
    this:showGetRewardEffect(tmpdata,true)
    log.r("lxq  GiftPackAnniversaryView.OnClaimEndlessGiftSuccess 领取成功")
    --现实第一个
end

--领取失败
function GiftPackAnniversaryView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
    log.r("lxq GiftPackAnniversaryView.OnClaimEndlessGiftFail")
end

--领取失败
function GiftPackAnniversaryView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
    log.r("lxq GiftPackAnniversaryView.OnFetchEndlessGiftFail")
end
