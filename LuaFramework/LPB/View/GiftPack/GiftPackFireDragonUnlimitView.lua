...
local GiftPackFireDragonUnlimitView = GiftPackBaseView:New('GiftPackFireDragonUnlimitView',"GiftPack_HotFixPack_GiftPackFireDragonUnlimit_AutoAtlas")
local this = GiftPackFireDragonUnlimitView
...
function GiftPackFireDragonUnlimitView:Awake(obj)
    self:on_init()
...
function GiftPackFireDragonUnlimitView:OnEnable()
    Facade.RegisterView(self)
    --   this:ClearMailList()
    self:BuildFsm(self)
    self:Bi_Tracker()
...
function GiftPackFireDragonUnlimitView:OnDisable()
...
function GiftPackFireDragonUnlimitView:ClearCountDown()
...
function GiftPackFireDragonUnlimitView:ShowItemGrid()
    ...
    self.candysweets2:ShowSprite(xls.icon)
end

function GiftPackFireDragonUnlimitView:ShowItemGridData(step,flag)
    _data = ModelList.GiftPackModel:GetShowGiftPack() 
    local tmpData = Csv.getPopInfiniteForId(_data.pId)
    local count = 0
...
function GiftPackFireDragonUnlimitView:movetoGrid(step,tflag)
    step = step or 1
    local rect = fun.get_component(self.item,fun.RECT)
    local y = step-1<=0 and 50 or  (((step-1) * rect.rect.height) +moveOffset)
...
function GiftPackFireDragonUnlimitView:ClearMailList()
...
function GiftPackFireDragonUnlimitView:GetItemViewInstance(index)
...
function GiftPackFireDragonUnlimitView:ShowDetailGift()
...
function GiftPackFireDragonUnlimitView:SetLeftTime(endTimeStamp)
...
function GiftPackFireDragonUnlimitView:OnDestroy()
    log.g("GiftPackFireDragonUnlimitView.OnDestroy ing !")
    Facade.RemoveView(self)
    self:Destroy()
    self:ClearMailList()
end

function GiftPackFireDragonUnlimitView:CloseFunc()
    Facade.SendNotification(NotifyName.HideUI, this)
end

function GiftPackFireDragonUnlimitView:ClosePackView()
...
function GiftPackFireDragonUnlimitView:on_btn_close_click()
    self:ClosePackView()
end

function GiftPackFireDragonUnlimitView:OnBuySuccess(needClose,itemData)
...
function GiftPackFireDragonUnlimitView:showGetRewardEffect(itemData,isFree)
...
function GiftPackFireDragonUnlimitView:SetTimer()
...
--领取成功
function GiftPackFireDragonUnlimitView.OnClaimEndlessGiftSuccess(data)
...
--领取失败
function GiftPackFireDragonUnlimitView.OnClaimEndlessGiftFail(data)
    --提示下领取失败
end

--查询成功
function GiftPackFireDragonUnlimitView.OnFetchEndlessGiftSuccess(data)
    selfstep = data.step
    local tmpflag = false
...
--领取失败
function GiftPackFireDragonUnlimitView.OnFetchEndlessGiftFail(data)
    --提示下查询失败
end
