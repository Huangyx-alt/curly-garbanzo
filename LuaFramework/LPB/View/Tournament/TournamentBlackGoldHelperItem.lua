...
local TournamentBlackGoldHelperItem = BaseView:New("TournamentBlackGoldHelperItem")
local this = TournamentBlackGoldHelperItem
...
function TournamentBlackGoldHelperItem:New(data)
    local o = {}
    self.__index = self
    setmetatable(o,self)
    o._data = data
...
function TournamentBlackGoldHelperItem:Awake()
    self:on_init()
end

function TournamentBlackGoldHelperItem:OnEnable()
    local view = require("View/CommonView/CollectRewardsItem")
    for key, value in pairs(self._data.reward_gold) do
...
function TournamentBlackGoldHelperItem:SetTitle()
...
function TournamentBlackGoldHelperItem:OnDisable()
    self._data = nil
end
