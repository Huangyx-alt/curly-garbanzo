...
local TournamentBlackGoldSettleTopPlayerView = BaseDialogView:New("TournamentBlackGoldSettleTopPlayerView","TournamentSettleTopPlayerAtlas")
local this = TournamentBlackGoldSettleTopPlayerView
...
function TournamentBlackGoldSettleTopPlayerView:Awake(obj)
    self:on_init()
end

function TournamentBlackGoldSettleTopPlayerView:OnEnable(params)
    ...
    self:SetMyTrophy()
    CommonState.BuildFsm(self,"TournamentBlackGoldSettleTopPlayerView")
    self:PlayEnterAnim()
    self:SetCollectInfo()
...
function TournamentBlackGoldSettleTopPlayerView:SetIsTopPlayer()
...
function TournamentBlackGoldSettleTopPlayerView:PlayEnterAnim()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
    local clipName = ""
    local motionName = ""
...
function TournamentBlackGoldSettleTopPlayerView:OnDisable()
...
function TournamentBlackGoldSettleTopPlayerView:DelayShowRewardByRank()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
...
function TournamentBlackGoldSettleTopPlayerView:StartCountDown()
...
function TournamentBlackGoldSettleTopPlayerView:SetTopPlayerInfo()
    local topPlayerInfo = ModelList.TournamentModel:GetTournamentResultTopPlayerData()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
...
function TournamentBlackGoldSettleTopPlayerView:SetPlayerInfo(index , playerInfo, playerObj , myRank)
...
function TournamentBlackGoldSettleTopPlayerView:ReBindRankImg(playerObj , rank)
    if playerObj then
...
function TournamentBlackGoldSettleTopPlayerView:CheckHasBlackCardReward(reward)
    if not reward then
        return false
    end
...
--排名在前三 放大背景 下移节点
function TournamentBlackGoldSettleTopPlayerView:SetViewNear()
    local nearVlaue = 1.3
...
--排名在前三 放大背景 上移界面
function TournamentBlackGoldSettleTopPlayerView:SetViewFar()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
    local nearVlaue = 1
    local farMoveDownPos = self.moveDown.transform.localPosition
...
function TournamentBlackGoldSettleTopPlayerView:SetMyRewardInfo()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
    if myRank <= 3 and isTopPlayer then
...
function TournamentBlackGoldSettleTopPlayerView:SetCollectInfo()
    local myRank = ModelList.TournamentModel:GetMyTournamentRank()
    if myRank <= 3 and isTopPlayer then
...
function TournamentBlackGoldSettleTopPlayerView:SetMyTrophy()
...
function TournamentBlackGoldSettleTopPlayerView:TopPlayerCollectRewardCloseView()
...
function TournamentBlackGoldSettleTopPlayerView:OepnTopPlayerBox(myRank)
    ...
    Facade.SendNotification(NotifyName.ShowUI,ViewList.TournamentBlackGoldSettleRewardView , nil,false , {startMovePos = startMovePos , rewardBox = rewardBox})
end

function TournamentBlackGoldSettleTopPlayerView:on_btn_collect_click()
...
function TournamentBlackGoldSettleTopPlayerView:DelayReturnState()
...
function TournamentBlackGoldSettleTopPlayerView:ResphoneRewardRequest()
    local rewards = ModelList.TournamentModel:GetMyTournamentRewardItem()
    self:FlyRewardToTopArea()
end

function TournamentBlackGoldSettleTopPlayerView:FlyRewardToTopArea()
    LuaTimer:SetDelayFunction(1, function()
...
function TournamentBlackGoldSettleTopPlayerView:RequestTournamentReward()
...
function TournamentBlackGoldSettleTopPlayerView:GetTopRewardBox(rank)
    return self.topRewardBoxList[rank]
end

function TournamentBlackGoldSettleTopPlayerView:PlayExit()
...
function TournamentBlackGoldSettleTopPlayerView:on_btn_continue_click()
    local animBtnConeTinue = fun.get_component(self.btn_continue , fun.ANIMATOR)
...
function TournamentBlackGoldSettleTopPlayerView:UpdateTargetClickBoxBtnEnable(index, state)
    fun.enable_button(self["btn_box" .. index] , state)
end

function TournamentBlackGoldSettleTopPlayerView:OpenTopPlayerRewardTip(index,offset , dir, pivot)
...
--测试用
-- function TournamentBlackGoldSettleTopPlayerView:GetTestReward(rewards , type)
...
function TournamentBlackGoldSettleTopPlayerView:SetTopPlayerUseToShow()
    self.topPlayerReward = {}
...
function TournamentBlackGoldSettleTopPlayerView:GetTopPlayerUseToShow(rankIndex)
...
function TournamentBlackGoldSettleTopPlayerView:GetShowTipWidth(rewardsNum)
    return (rewardsNum - 1) * 150 + 180
end


function TournamentBlackGoldSettleTopPlayerView.ReqWeekSettleError()
