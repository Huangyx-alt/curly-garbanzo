...
local PirateShipPuSkill = BaseSkill:New("PirateShipPuSkill")
local this = PirateShipPuSkill
local private = {}

function PirateShipPuSkill:ShowSkill(cardId, cellIndex, powerId, skillId)
    ...
    BattleEffectCache:GetSkillPrefabFromCache("PirateShipPuSkill", target, function(obj)
