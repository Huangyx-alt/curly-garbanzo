...
local NewLeetoleManPuSkill = BaseSkill:New("NewLeetoleManPuSkill")
local this = NewLeetoleManPuSkill
local private = {}

function NewLeetoleManPuSkill:ShowSkill(cardId, cellIndex, powerId, skillId)
    ...
    BattleEffectCache:GetSkillPrefabFromCache("NewLeetoleManskill2", target, function(obj)
        UISound.play("newleetolemanmirror")
