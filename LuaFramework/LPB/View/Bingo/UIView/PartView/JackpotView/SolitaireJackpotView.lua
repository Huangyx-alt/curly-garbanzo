local SolitaireJackpotView = BaseChildView:New()
local this = SolitaireJackpotView
...
function SolitaireJackpotView:New()
    local o = {}
    this.__index = this
    setmetatable(o, this)
    return o
...
function SolitaireJackpotView:Init(jackpotRef, jackpotRuleId, jackPar)
...
function SolitaireJackpotView:OutScreenOpen()
...
function SolitaireJackpotView:Show()
    if this.isShowned then   return   end
    this.isShowned = true
    fun.set_active(this.jackpotRoot, false)
end

function SolitaireJackpotView:OnDisable()
    this.jackpotList = nil
    this.itemList = {}
