...
local NewLeetoleManBingoView = BaseBingoView:New("NewLeetoleManBingoView", "NewLeetoleManBingoAtlas")
local this = NewLeetoleManBingoView
this.ViewName = "NewLeetoleManBingoView"
