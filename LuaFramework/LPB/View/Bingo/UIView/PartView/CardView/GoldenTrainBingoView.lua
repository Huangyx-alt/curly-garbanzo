...
local GoldenTrainBingoView = BaseBingoView:New("GoldenTrainBingoView", "GoldenTrainBingoAtlas")
local this = GoldenTrainBingoView
this.ViewName = "GoldenTrainBingoView"
