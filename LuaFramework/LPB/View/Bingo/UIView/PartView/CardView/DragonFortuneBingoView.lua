...
local DragonFortuneBingoView = BaseBingoView:New("DragonFortuneBingoView", "DragonFortuneBingoAtlas")
local this = DragonFortuneBingoView
this.ViewName = "DragonFortuneBingoView"
