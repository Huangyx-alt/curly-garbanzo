...
local HorseRacingBingoView = BaseBingoView:New("HorseRacingBingoView", "HorseRacingBingoAtlas")
local this = HorseRacingBingoView
this.ViewName = "HorseRacingBingoView"
