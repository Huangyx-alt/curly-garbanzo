...
---@class NewChristmasGameCardView : GameCardView
local NewChristmasGameCardView = GameCardView:New("NewChristmasGameCardView")
local this = NewChristmasGameCardView
