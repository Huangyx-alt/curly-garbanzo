...
---@class GemQueenGameCardView : GameCardView
local GemQueenGameCardView = GameCardView:New("GemQueenGameCardView")
local this = GemQueenGameCardView
    ...
    table.each(self.model:GetRoundData(), function(cardData, cardID)
        table.each(cardData.cards, function(cellData)
            ...
            if treasureItems then
                ...
                -- 皇冠
                if 28 == data.result[1] and 1 == data.result[2] then
