...
---@class NewLeetoleManGameCardView : GameCardView
local NewLeetoleManGameCardView = GameCardView:New("NewLeetoleManGameCardView")
local this = NewLeetoleManGameCardView
