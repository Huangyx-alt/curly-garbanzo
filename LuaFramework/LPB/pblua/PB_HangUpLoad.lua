...
--****** 挂机-gameLoad *********--
 PB_HangUpLoad_Req  =  {
    ...
    couponId            =  5,-- int32 couponId ,--优惠券id 保留，但自需求1.3开始废弃
    subType             =  6,--	int32 subType ,--子玩法id 参考PLAY_SUB_TYPE
    useCouponId        =  7,--	string useCouponId ,--使用的时候参数-唯一id
}
 ...
 PB_HangUpLoad_Res  =  {
    ...
    bingoRuleId                                   =  1,-- int32 bingoRuleId 4,--卡面bingo判断规则id
    jackpotRuleId                                 =  1,-- int32 jackpotRuleId 5,--卡面jackpot判断规则id
