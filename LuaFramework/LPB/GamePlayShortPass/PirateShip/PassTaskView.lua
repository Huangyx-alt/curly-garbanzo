...
this.atlasName = "PirateShipPassTaskAtlas"
this.longTaskAtlasName = "PirateShipPassTaskAtlas"
...
function PassTaskView:OnEnable(params)
    ...
    if not ModelList.GuideModel:IsGuideComplete(74) then
        ModelList.GuideModel:TriggerPassTaskView(557)
    end
end
