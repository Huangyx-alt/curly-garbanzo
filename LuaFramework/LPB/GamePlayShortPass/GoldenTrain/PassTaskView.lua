...
this.atlasName = "GoldenTrainPassTaskAtlas"
this.longTaskAtlasName = "GoldenTrainPassTaskAtlas"
...
function PassTaskView:OnEnable(params)
    ...
    --- flag:短令牌 每次增加新的短令牌都要修改
    if not ModelList.GuideModel:IsGuideComplete(84) then
        ModelList.GuideModel:TriggerPassTaskView(582)
    end
end
