...
this.atlasName = "BisonPassTaskAtlas"
this.longTaskAtlasName = "BisonPassTaskAtlas"
...
function PassTaskView:OnEnable(params)
    ...
    --- flag:短令牌 每次增加新的短令牌都要修改
    if not ModelList.GuideModel:IsGuideComplete(75) then
        ModelList.GuideModel:TriggerPassTaskView(561)
    end
end
